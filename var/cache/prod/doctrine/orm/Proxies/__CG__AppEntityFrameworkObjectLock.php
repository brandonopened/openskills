 ...
 */
class ObjectLock extends \App\Entity\Framework\ObjectLock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'timeout', 'objectType', 'objectId', 'doc'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObjectLock $proxy) {
    ...
    public function getTimeout(): \DateTime
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTimeout', []);
    ...
    public function addTime(int $minutes): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTime', [$minutes]);

        parent::addTime($minutes);
    }
