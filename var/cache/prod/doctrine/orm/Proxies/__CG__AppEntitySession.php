...
class Session extends \App\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Session' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Session' . "\0" . 'data', '' . "\0" . 'App\\Entity\\Session' . "\0" . 'lastUsed', '' . "\0" . 'App\\Entity\\Session' . "\0" . 'lifetime'];
        }
    ...
    public function getLastUsedTime(): \DateTimeImmutable
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastUsedTime', []);

        return parent::getLastUsedTime();
    }
