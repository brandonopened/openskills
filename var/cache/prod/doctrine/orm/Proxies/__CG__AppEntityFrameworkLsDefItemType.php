 ...
 */
class LsDefItemType extends \App\Entity\Framework\LsDefItemType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDefItemType' . "\0" . 'code', '' . "\0" . 'App\\Entity\\Framework\\LsDefItemType' . "\0" . 'hierarchyCode', 'title', 'description', 'id', 'identifier', 'uri', 'extra', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDefItemType $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCode(?string $code): \App\Entity\Framework\LsDefItemType
    {
     ...
     * {@inheritDoc}
     */
    public function setHierarchyCode(string $hierarchyCode): \App\Entity\Framework\LsDefItemType
    {
