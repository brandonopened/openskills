 ...
 */
class LsDefConcept extends \App\Entity\Framework\LsDefConcept implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDefConcept' . "\0" . 'hierarchyCode', '' . "\0" . 'App\\Entity\\Framework\\LsDefConcept' . "\0" . 'keywords', 'title', 'description', 'id', 'identifier', 'uri', 'extra', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDefConcept $proxy) {
    ...
    public function getHierarchyCode(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHierarchyCode', []);

        return parent::getHierarchyCode();
    }

    /**
     * {@inheritDoc}
     */
    public function setHierarchyCode(string $hierarchyCode): \App\Entity\Framework\LsDefConcept
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHierarchyCode', [$hierarchyCode]);

        return parent::setHierarchyCode($hierarchyCode);
    }
     ...
     * {@inheritDoc}
     */
    public function setKeywords(?string $keywords): \App\Entity\Framework\LsDefConcept
    {
