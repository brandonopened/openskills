 ...
 */
class LsDefLicence extends \App\Entity\Framework\LsDefLicence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDefLicence' . "\0" . 'licenceText', 'title', 'description', 'id', 'identifier', 'uri', 'extra', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDefLicence $proxy) {
    ...
    public function getLicenceText()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLicenceText', []);

        return parent::getLicenceText();
    }
    ...
    public function setLicenceText($licenceText)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLicenceText', [$licenceText]);

        return parent::setLicenceText($licenceText);
    }
