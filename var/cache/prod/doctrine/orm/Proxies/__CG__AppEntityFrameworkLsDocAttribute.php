 ...
 */
class LsDocAttribute extends \App\Entity\Framework\LsDocAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDocAttribute' . "\0" . 'lsDoc', '' . "\0" . 'App\\Entity\\Framework\\LsDocAttribute' . "\0" . 'attribute', '' . "\0" . 'App\\Entity\\Framework\\LsDocAttribute' . "\0" . 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDocAttribute $proxy) {
