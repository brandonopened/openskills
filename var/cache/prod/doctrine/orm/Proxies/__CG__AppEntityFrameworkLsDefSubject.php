 ...
 */
class LsDefSubject extends \App\Entity\Framework\LsDefSubject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDefSubject' . "\0" . 'hierarchyCode', 'title', 'description', 'id', 'identifier', 'uri', 'extra', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDefSubject $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setHierarchyCode(string $hierarchyCode): \App\Entity\Framework\LsDefSubject
    {
