 ...
 */
class LsDefGrade extends \App\Entity\Framework\LsDefGrade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Framework\\LsDefGrade' . "\0" . 'code', '' . "\0" . 'App\\Entity\\Framework\\LsDefGrade' . "\0" . 'rank', 'title', 'description', 'id', 'identifier', 'uri', 'extra', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LsDefGrade $proxy) {
