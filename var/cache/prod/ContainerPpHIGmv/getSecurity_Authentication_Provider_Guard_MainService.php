...
class getSecurity_Authentication_Provider_Guard_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), ($container->privates['security.user.provider.concrete.local_db_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_LocalDbProviderService')), 'main', new \App\Security\UserChecker(), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
