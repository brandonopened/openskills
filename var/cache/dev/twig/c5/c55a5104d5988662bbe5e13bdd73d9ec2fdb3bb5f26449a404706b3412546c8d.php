...
class __TwigTemplate_ce125f3eefd6550e93f932149345b55b722392d6255074226e347dab0bb35e7d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_datalist_widget($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e = $this->extensions["Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension"];
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "datalist_widget"));
        ...
        echo "_list\" value=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), "vars", [], "any", false, false, false, 2), "value", [], "any", false, false, false, 2), "html", null, true);
        echo "\"  maxlength=\"300\" class=\"form-control\"/>
    <datalist id=\"";
        // line 3
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["choices"]) || array_key_exists("choices", $context) ? $context["choices"] : (function () { throw new RuntimeError('Variable "choices" does not exist.', 4, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["choice"]) {
            // line 5
            echo "            <option>
                ";
            // line 6
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["choice"], "label", [], "any", false, false, false, 6), "html", null, true);
            echo "
            </option>
        ";
        }
...
";
    ...
    {
        return array (  96 => 9,  87 => 6,  84 => 5,  80 => 4,  76 => 3,  67 => 2,  57 => 1,  46 => 11,  44 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% block datalist_widget %}
    <input {{ block('widget_attributes') }} list=\"{{ form.vars.id }}_list\" value=\"{{ form.vars.value }}\"  maxlength=\"300\" class=\"form-control\"/>
