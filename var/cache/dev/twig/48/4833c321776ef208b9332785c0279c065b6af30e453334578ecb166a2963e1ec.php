...
/* layout.html.twig */
class __TwigTemplate_f304660a44bd38d059e585c7cbf2076205b1d64e3a07a17e98982a6780e34f81 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 1, $this->source); })()), "request", [], "any", false, false, false, 1), "xmlHttpRequest", [], "any", false, false, false, 1)) ? ("base_ajax.html.twig") : (        // line 3
(isset($context["base_template"]) || array_key_exists("base_template", $context) ? $context["base_template"] : (function () { throw new RuntimeError('Variable "base_template" does not exist.', 3, $this->source); })()))), "layout.html.twig", 3);
    }
