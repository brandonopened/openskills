...
class getSwiftmailer_Mailer_Default_Transport_RealService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['swiftmailer.mailer.default.transport.real'] = \Symfony\Bundle\SwiftmailerBundle\DependencyInjection\SwiftmailerTransportFactory::createTransport(['transport' => $container->getEnv('MAILER_TRANSPORT'), 'url' => NULL, 'username' => $container->getEnv('MAILER_USER'), 'password' => $container->getEnv('MAILER_PASSWORD'), 'host' => $container->getEnv('MAILER_HOST'), 'port' => $container->getEnv('int:MAILER_PORT'), 'timeout' => 30, 'source_ip' => NULL, 'local_domain' => NULL, 'encryption' => NULL, 'auth_mode' => $container->getEnv('MAILER_AUTH_MODE'), 'command' => '/usr/sbin/sendmail -bs'], ($container->privates['router.request_context'] ?? $container->getRouter_RequestContextService()), ($container->privates['swiftmailer.mailer.default.transport.eventdispatcher'] ?? ($container->privates['swiftmailer.mailer.default.transport.eventdispatcher'] = new \Swift_Events_SimpleEventDispatcher())));
    }
}
