...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventListener/SiteVersionListener.php';
            include_once \dirname(__DIR__, 4).'/src/EventListener/VaryOriginListener.php';
            include_once \dirname(__DIR__, 4).'/src/Security/Session/SessionIdleHandler.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/Extension/CaseUriExtension.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/AuditManager.php';
            include_once \dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/EventListener/LogRevisionsListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/EventListener/CreateSchemaListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/User/TokenStorageUsernameCallable.php';
            include_once \dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/AuditConfiguration.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/EventListener/ExternalRedirectListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/ExternalRedirect/TargetValidator.php';
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/ExternalRedirect/WhitelistBasedTargetValidator.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/ToggleCollection.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/ToggleCollection/InMemoryCollection.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/Serializer/InMemoryCollectionSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/ToggleManager.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/ContextFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/Context/UserContextFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/Twig/ToggleTwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle/lib/Qandidate/Toggle/Context.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/EventListener/ToggleListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/DataCollector/ToggleCollector.php';
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ($this->privates['doctrine.dbal.connection_factory'] ?? $this->getDoctrine_Dbal_ConnectionFactoryService())->createConnection(['driver' => 'pdo_mysql', 'host' => $this->getEnv('MYSQL_HOST'), 'port' => $this->getEnv('int:MYSQL_PORT'), 'dbname' => $this->getEnv('MYSQL_DATABASE'), 'user' => $this->getEnv('MYSQL_USER'), 'password' => $this->getEnv('MYSQL_PASSWORD'), 'charset' => 'utf8mb4', 'driverOptions' => [], 'serverVersion' => 5.7, 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], ($this->privates['doctrine.dbal.default_connection.configuration'] ?? $this->getDoctrine_Dbal_DefaultConnection_ConfigurationService()), $a, ['json' => 'string', 'uuid_binary' => 'binary', 'uuid_binary_ordered_time' => 'binary']);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(($this->privates['csa_guzzle.data_collector.guzzle'] ?? $this->getCsaGuzzle_DataCollector_GuzzleService()));
        $instance->add(($this->privates['qandidate.toggle.data_collector.toggle_collector'] ?? $this->getQandidate_Toggle_DataCollector_ToggleCollectorService()));
    ...
    protected function getSimplethingsEntityaudit_ConfigService()
    {
        ...
        $instance->setUsernameCallable(($this->privates['simplethings_entityaudit.username_callable.token_storage'] ?? ($this->privates['simplethings_entityaudit.username_callable.token_storage'] = new \SimpleThings\EntityAudit\User\TokenStorageUsernameCallable($this))));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(($this->privates['App\\Twig\\Extension\\CaseUriExtension'] ?? ($this->privates['App\\Twig\\Extension\\CaseUriExtension'] = new \App\Twig\Extension\CaseUriExtension())));
        ...
        $instance->addExtension(($this->privates['csa_guzzle.twig.extension'] ?? ($this->privates['csa_guzzle.twig.extension'] = new \Csa\Bundle\GuzzleBundle\Twig\Extension\GuzzleExtension())));
        $instance->addExtension(($this->privates['nelmio_security.twig_extension'] ?? $this->getNelmioSecurity_TwigExtensionService()));
        $instance->addExtension(($this->privates['qandidate.toggle.twig_extension'] ?? $this->getQandidate_Toggle_TwigExtensionService()));
        ...
        $instance->addGlobal('github_client_id', $this->getEnv('GITHUB_CLIENT_ID'));
        $instance->addGlobal('brand_logo_url', $this->getEnv('BRAND_LOGO_URL'));
        $instance->addGlobal('brand_logo_style', $this->getEnv('BRAND_LOGO_STYLE'));
        $instance->addGlobal('brand_link_url', $this->getEnv('BRAND_LINK_URL'));
        $instance->addGlobal('brand_link_style', $this->getEnv('BRAND_LINK_STYLE'));
        $instance->addGlobal('firebase_api_key', $this->getEnv('FIREBASE_API_KEY'));
        $instance->addGlobal('firebase_auth_domain', $this->getEnv('FIREBASE_AUTH_DOMAIN'));
        $instance->addGlobal('firebase_db_url', $this->getEnv('FIREBASE_DB_URL'));
        $instance->addGlobal('firebase_project_id', $this->getEnv('FIREBASE_PROJECT_ID'));
        $instance->addGlobal('firebase_prefix', $this->getEnv('FIREBASE_PREFIX'));
        $instance->addGlobal('google_captcha_site_key', $this->getEnv('GOOGLE_CAPTCHA_SITE_KEY'));
        $instance->addGlobal('footer_left_text', $this->getEnv('FOOTER_LEFT_TEXT'));
    ...
    /**
     * Gets the private 'App\EventListener\VaryOriginListener' shared autowired service.
     *
     * @return \App\EventListener\VaryOriginListener
     */
    protected function getVaryOriginListenerService()
    {
        return $this->privates['App\\EventListener\\VaryOriginListener'] = new \App\EventListener\VaryOriginListener();
    }
    ...
    /**
     * Gets the private 'App\Twig\Extension\CaseUriExtension' shared autowired service.
     *
     * @return \App\Twig\Extension\CaseUriExtension
     */
    protected function getCaseUriExtensionService()
    {
        return $this->privates['App\\Twig\\Extension\\CaseUriExtension'] = new \App\Twig\Extension\CaseUriExtension();
    }

    /**
     * Gets the private 'Twig\Extensions\TextExtension' shared autowired service.
     *
     * @return \Twig\Extensions\TextExtension
     */
    protected function getTextExtensionService()
    {
        return $this->privates['Twig\\Extensions\\TextExtension'] = new \Twig\Extensions\TextExtension();
    }
    ...
    /**
     * Gets the private 'assets._package_encore' shared service.
     *
     * @return \Symfony\Component\Asset\PathPackage
     */
    protected function getAssets_PackageEncoreService()
    {
        return $this->privates['assets._package_encore'] = new \Symfony\Component\Asset\PathPackage('', ($this->privates['assets._version_encore'] ?? ($this->privates['assets._version_encore'] = new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/public/build/manifest.json')))), ($this->privates['assets.context'] ?? $this->getAssets_ContextService()));
    }
    ...
    {
        return $this->privates['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('190202', '%s?%s');
    }

    /**
     * Gets the private 'assets._version_encore' shared service.
     *
     * @return \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy
     */
    protected function getAssets_VersionEncoreService()
    {
        return $this->privates['assets._version_encore'] = new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/public/build/manifest.json'));
    }
    ...
    {
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(($this->privates['assets._default_package'] ?? $this->getAssets_DefaultPackageService()), ['encore' => ($this->privates['assets._package_encore'] ?? $this->getAssets_PackageEncoreService())]);
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bfj7qvvhcA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fsd14TkpOR', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.doctrine.orm.default.second_level.region_driver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($this->privates['cache.doctrine.orm.default.second_level.region_driver.recorder_inner'] ?? ($this->privates['cache.doctrine.orm.default.second_level.region_driver.recorder_inner'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter())));
    }

    /**
     * Gets the private 'cache.doctrine.orm.default.second_level.region_driver.recorder_inner' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\ArrayAdapter
     */
    protected function getCache_Doctrine_Orm_Default_SecondLevel_RegionDriver_RecorderInnerService()
    {
        return $this->privates['cache.doctrine.orm.default.second_level.region_driver.recorder_inner'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter();
    }
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KQ2QfO9oh4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pfRlKSlW5d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hKeK4vr+gP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MVLR1Xrcgj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4KI7Uuq88K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['csa_guzzle.data_collector.guzzle'] = new \Csa\Bundle\GuzzleBundle\DataCollector\GuzzleCollector(65536, ($this->services['csa_guzzle.data_collector.history_bag'] ?? ($this->services['csa_guzzle.data_collector.history_bag'] = new \Csa\GuzzleHttp\Middleware\History\History())));
    }
    ...
    {
        return $this->privates['csa_guzzle.twig.extension'] = new \Csa\Bundle\GuzzleBundle\Twig\Extension\GuzzleExtension();
    }
    ...
    protected function getDataCollector_CacheService()
    {
        ...
        $instance->addInstance('cache.doctrine.orm.default.second_level.region_driver', ($this->privates['cache.doctrine.orm.default.second_level.region_driver'] ?? $this->getCache_Doctrine_Orm_Default_SecondLevel_RegionDriverService()));
    ...
    protected function getDebug_Security_Access_DecisionManager_InnerService()
    {
        return $this->privates['debug.security.access.decision_manager.inner'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\AssociationVoter'] ?? $this->load('getAssociationVoter2Service'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CommentVoter'] ?? $this->load('getCommentVoter2Service'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\FeatureVoter'] ?? $this->load('getFeatureVoter2Service'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Voter\\FrameworkAccessVoter'] ?? $this->load('getFrameworkAccessVoter2Service'));
            yield 7 => ($this->privates['debug.security.voter.App\\Security\\Voter\\FrameworkManageEditorsVoter'] ?? $this->load('getFrameworkManageEditorsVoter2Service'));
            yield 8 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ItemVoter'] ?? $this->load('getItemVoter2Service'));
            yield 9 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ManageAdditionalFieldVoter'] ?? $this->load('getManageAdditionalFieldVoter2Service'));
            yield 10 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ManageLogVoter'] ?? $this->load('getManageLogVoter2Service'));
            yield 11 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ManageMirrorVoter'] ?? $this->load('getManageMirrorVoter2Service'));
            yield 12 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ManageOrganizationVoter'] ?? $this->load('getManageOrganizationVoter2Service'));
            yield 13 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ManageUserVoter'] ?? $this->load('getManageUserVoter2Service'));
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] ?? $this->getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService()));
        $instance->addEventSubscriber(($this->privates['simplethings_entityaudit.log_revisions_listener'] ?? $this->getSimplethingsEntityaudit_LogRevisionsListenerService()));
        $instance->addEventSubscriber(($this->privates['simplethings_entityaudit.create_schema_listener'] ?? $this->getSimplethingsEntityaudit_CreateSchemaListenerService()));
    ...
    {
        return $this->privates['doctrine.dbal.default_regex_schema_filter'] = new \Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter('~^(?!(cache_items|LearningStandards|std_*|map_*|grade_level))~');
    }
    ...
    {
        return $this->privates['doctrine.dbal.default_schema_asset_filter_manager'] = new \Doctrine\Bundle\DoctrineBundle\Dbal\SchemaAssetsFilterManager([0 => ($this->privates['doctrine.dbal.well_known_schema_asset_filter'] ?? ($this->privates['doctrine.dbal.well_known_schema_asset_filter'] = new \Doctrine\Bundle\DoctrineBundle\Dbal\BlacklistSchemaAssetFilter([0 => 'sessions', 1 => 'cache_items']))), 1 => ($this->privates['doctrine.dbal.default_regex_schema_filter'] ?? ($this->privates['doctrine.dbal.default_regex_schema_filter'] = new \Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter('~^(?!(cache_items|LearningStandards|std_*|map_*|grade_level))~')))]);
    }
    ...
    /**
     * Gets the private 'doctrine.dbal.well_known_schema_asset_filter' shared service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\Dbal\BlacklistSchemaAssetFilter
     */
    protected function getDoctrine_Dbal_WellKnownSchemaAssetFilterService()
    {
        return $this->privates['doctrine.dbal.well_known_schema_asset_filter'] = new \Doctrine\Bundle\DoctrineBundle\Dbal\BlacklistSchemaAssetFilter([0 => 'sessions', 1 => 'cache_items']);
    }
    ...
    /**
     * Gets the private 'doctrine.orm.cache.provider.cache.doctrine.orm.default.second_level.region_driver' shared service.
     *
     * @return \Symfony\Component\Cache\DoctrineProvider
     */
    protected function getDoctrine_Orm_Cache_Provider_Cache_Doctrine_Orm_Default_SecondLevel_RegionDriverService()
    {
        return $this->privates['doctrine.orm.cache.provider.cache.doctrine.orm.default.second_level.region_driver'] = new \Symfony\Component\Cache\DoctrineProvider(($this->privates['cache.doctrine.orm.default.second_level.region_driver'] ?? $this->getCache_Doctrine_Orm_Default_SecondLevel_RegionDriverService()));
    }
    ...
    {
        return $this->privates['doctrine.orm.default_annotation_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Entity'), 1 => (\dirname(__DIR__, 4).'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Tree/Entity')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $a->setCacheLogger($b);
        $a->setCacheFactory(new \Doctrine\ORM\Cache\DefaultCacheFactory(($this->privates['doctrine.orm.default_second_level_cache.regions_configuration'] ?? ($this->privates['doctrine.orm.default_second_level_cache.regions_configuration'] = new \Doctrine\ORM\Cache\RegionsConfiguration())), ($this->privates['doctrine.orm.cache.provider.cache.doctrine.orm.default.second_level.region_driver'] ?? $this->getDoctrine_Orm_Cache_Provider_Cache_Doctrine_Orm_Default_SecondLevel_RegionDriverService())));
        $a->setRegionsConfiguration(new \Doctrine\ORM\Cache\RegionsConfiguration());

        $instance->setEntityNamespaces(['App' => 'App\\Entity', 'GedmoTree' => 'Gedmo\\Tree\\Entity']);
        $instance->setSecondLevelCacheEnabled(false);
    ...
    {
        return $this->privates['doctrine.orm.default_second_level_cache.regions_configuration'] = new \Doctrine\ORM\Cache\RegionsConfiguration();
    }
    ...
    {
        $a = ($this->privates['salt.cache.external_docs'] ?? $this->getSalt_Cache_ExternalDocsService());

        if (isset($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'])) {
            return $this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'];
        }

        return $this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] = new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([0 => $a]);
    }
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler('php://stdout', 100, true, NULL, false);
    ...
    {
        return $this->privates['nelmio_security.external_redirect_listener'] = new \Nelmio\SecurityBundle\EventListener\ExternalRedirectListener(false, NULL, NULL, ($this->privates['nelmio_security.external_redirect.target_validator.whitelist'] ?? ($this->privates['nelmio_security.external_redirect.target_validator.whitelist'] = new \Nelmio\SecurityBundle\ExternalRedirect\WhitelistBasedTargetValidator('(?:.*\\.google\\.com|google\\.com)'))), NULL, ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    {
        return $this->privates['nelmio_security.nonce_generator'] = new \Nelmio\SecurityBundle\ContentSecurityPolicy\NonceGenerator(16);
    }
    ...
    {
        return $this->privates['nelmio_security.sha_computer'] = new \Nelmio\SecurityBundle\ContentSecurityPolicy\ShaComputer('sha256');
    }

    /**
     * Gets the private 'nelmio_security.twig_extension' shared service.
     *
     * @return \Nelmio\SecurityBundle\Twig\NelmioCSPTwigExtension
     */
    protected function getNelmioSecurity_TwigExtensionService()
    {
        return $this->privates['nelmio_security.twig_extension'] = new \Nelmio\SecurityBundle\Twig\NelmioCSPTwigExtension(($this->privates['nelmio_security.csp_listener'] ?? $this->getNelmioSecurity_CspListenerService()), ($this->privates['nelmio_security.sha_computer'] ?? ($this->privates['nelmio_security.sha_computer'] = new \Nelmio\SecurityBundle\ContentSecurityPolicy\ShaComputer('sha256'))));
    }
    ...
    /**
     * Gets the private 'qandidate.toggle.collection.serializer.in_memory' shared service.
     *
     * @return \Qandidate\Toggle\Serializer\InMemoryCollectionSerializer
     */
    protected function getQandidate_Toggle_Collection_Serializer_InMemoryService()
    {
        return $this->privates['qandidate.toggle.collection.serializer.in_memory'] = new \Qandidate\Toggle\Serializer\InMemoryCollectionSerializer();
    }

    /**
     * Gets the private 'qandidate.toggle.context' shared service.
     *
     * @return \Qandidate\Toggle\Context
     */
    protected function getQandidate_Toggle_ContextService()
    {
        return $this->privates['qandidate.toggle.context'] = ($this->services['qandidate.toggle.user_context_factory'] ?? $this->getQandidate_Toggle_UserContextFactoryService())->createContext();
    }

    /**
     * Gets the private 'qandidate.toggle.data_collector.toggle_collector' shared service.
     *
     * @return \Qandidate\Bundle\ToggleBundle\DataCollector\ToggleCollector
     */
    protected function getQandidate_Toggle_DataCollector_ToggleCollectorService()
    {
        return $this->privates['qandidate.toggle.data_collector.toggle_collector'] = new \Qandidate\Bundle\ToggleBundle\DataCollector\ToggleCollector(($this->services['qandidate.toggle.manager'] ?? $this->getQandidate_Toggle_ManagerService()), ($this->services['qandidate.toggle.user_context_factory'] ?? $this->getQandidate_Toggle_UserContextFactoryService()));
    }
    ...
    {
        return $this->privates['qandidate.toggle.toggle.listener'] = new \Qandidate\Bundle\ToggleBundle\EventListener\ToggleListener(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), ($this->services['qandidate.toggle.manager'] ?? $this->getQandidate_Toggle_ManagerService()), ($this->privates['qandidate.toggle.context'] ?? $this->getQandidate_Toggle_ContextService()));
    }

    /**
     * Gets the private 'qandidate.toggle.twig_extension' shared service.
     *
     * @return \Qandidate\Bundle\ToggleBundle\Twig\ToggleTwigExtension
     */
    protected function getQandidate_Toggle_TwigExtensionService()
    {
        return $this->privates['qandidate.toggle.twig_extension'] = new \Qandidate\Bundle\ToggleBundle\Twig\ToggleTwigExtension(($this->services['qandidate.toggle.manager'] ?? $this->getQandidate_Toggle_ManagerService()), ($this->services['qandidate.toggle.user_context_factory'] ?? $this->getQandidate_Toggle_UserContextFactoryService()));
    }
     ...
     */
    protected function getSalt_Cache_ExternalDocsService()
    {
        $a = ($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService());

        if (isset($this->privates['salt.cache.external_docs'])) {
            return $this->privates['salt.cache.external_docs'];
        }

        $this->privates['salt.cache.external_docs'] = $instance = new \Symfony\Component\Cache\Adapter\PdoAdapter($a, 'externalDoc-');
    ...
    {
        return $this->privates['simplethings_entityaudit.username_callable.token_storage'] = new \SimpleThings\EntityAudit\User\TokenStorageUsernameCallable($this);
    }
    ...
    protected function getTwig_Loader_NativeFilesystemService()
    {
        ...
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/Resources/views'), 'SimpleThingsEntityAudit');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/Resources/views'), '!SimpleThingsEntityAudit');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/csa/guzzle-bundle/src/Resources/views'), 'CsaGuzzle');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/csa/guzzle-bundle/src/Resources/views'), '!CsaGuzzle');
        $instance->addPath((\dirname(__DIR__, 4).'/templates/bundles/TetranzSelect2EntityBundle'), 'TetranzSelect2Entity');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/tetranz/select2entity-bundle/Resources/views'), 'TetranzSelect2Entity');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/tetranz/select2entity-bundle/Resources/views'), '!TetranzSelect2Entity');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/Resources/views'), 'QandidateToggle');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/qandidate/toggle-bundle/Resources/views'), '!QandidateToggle');
        ...
        return [
            ...
            'data_collector.templates' => [
                ...
                'qandidate.toggle.data_collector.toggle_collector' => [
                    0 => 'qandidate.toggle_collector',
                    1 => '@QandidateToggle\\data_collector\\toggle.html.twig',
                ],
